...
export function Dashboard() {
    ...
    return (
        <div>
        <NavBar />
        <div className="container mx-auto my-6 p-6 bg-gradient-to-r from-[#6a4c93] to-[#a76ab7] shadow-lg rounded-lg">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-white">
                    Dashboard del tablero: {board ? board.nombreTablero : "Cargando..."}
                </h1>
                <button
                    className="bg-teal-500 text-white p-2 rounded hover:bg-teal-600 transition duration-300"
        ...
        <div className="container mx-auto my-6 p-8 bg-white shadow-lg rounded-lg"> 
            <div className="flex justify-around">
                <div className="flex flex-col items-center">
                    <h2 className="text-xl font-bold text-gray-800 mt-4">Tareas por Estado</h2>
                ...
                <div className="flex flex-col items-center">
                    <h2 className="text-xl font-bold text-gray-800 mt-4">Total de Tareas Atrasadas</h2>
                ...
                <div className="flex flex-col items-center">
                    <h2 className="text-xl font-bold text-gray-800 mt-4">Tareas por Usuario</h2>
                    <PieChart width={350} height={350}>
                        <Pie 
                            data={tasksByUser}
                            dataKey="total"
